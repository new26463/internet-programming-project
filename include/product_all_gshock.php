<?php
	...
	$select = "select * from product where prod_brand = 'Gshock' limit {$start} , {$perpage}";
...
<?php } ?>
<?php
	$select = "select * from product where prod_brand = 'Gshock'";
	$run = mysqli_query($con,$select);
...
<center style="clear:both">
	<ul class="pagination">
		<li>
			<a href="gshock.php?page=1" aria-label="Previous">
				<span aria-hidden="true">&laquo;</span>
			</a>
		</li>
		<?php for($i=1;$i<=$total_page;$i++){ ?>
			<li><a href="gshock.php?page=<?php echo $i; ?>"><?php echo $i; ?></a></li>
		<?php } ?>
		<li>
			<a href="gshock.php?page=<?php echo $total_page;?>" aria-label="Next">
